...
def main(args):
    ...
    Tests the model on unseen data
        ...
        - Saves incorrect predictions to a CSV file
        - Cleans I_tags that are not preceded by the correct B_tag with a B_tag
    """
    ...
    # Train and validate the model on the training and validation sets
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train and test a sequence tagging model")

    parser.add_argument(
        "train_data", type=str, help="Path to the training data CSV file."
    )
